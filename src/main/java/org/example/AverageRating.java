...
public class AverageRating {
    public static void main(String[] args) throws Exception {
        ...
        DataSet<Tuple3<Long, String, String>> movies = env.readCsvFile("/Users/inistar/IdeaProjects/movieanalysis/src/main/resources/ml-latest-small/movies.csv")
                .ignoreFirstLine()
                .parseQuotedStrings('"')
                .ignoreInvalidLines()
                .types(Long.class, String.class, String.class);

        DataSet<Tuple2<Long, Double>> ratings = env.readCsvFile("/Users/inistar/IdeaProjects/movieanalysis/src/main/resources/ml-latest-small/ratings.csv")
                .ignoreFirstLine()
